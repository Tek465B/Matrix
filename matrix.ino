...
const byte backLight = 9;  // D10 - Use PWM to change brightness
const byte contrast = 8;    // D3  - Use PWM to change contrast  Connect 100uF between pin and GND
...
void loop(){
  if (rxbyte == 254) //Matrix Orbital uses 254 prefix for commands
  {
    ...
    case 198: //Send byte command to lcd
      ...
      lcd.command(temp);
      break;
    case 199: //Scroll Left
      lcd.command(0b00011000); //dec 28
      break;
    case 200: //Scroll Right
      lcd.command(0b00011100); // dec 24
      break;
    case 201: //Scroll Right
      lcd.command(serial_getch()); // dec 24
      break;
    default:
